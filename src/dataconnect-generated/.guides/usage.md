...
```ts
import { useCreateOrderRequest, useUpdateProjectStatus, useListMyOrderRequests, useDeleteProject } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateOrderRequest(createOrderRequestVars);

const { data, isPending, isSuccess, isError, error } = useUpdateProjectStatus(updateProjectStatusVars);

const { data, isPending, isSuccess, isError, error } = useListMyOrderRequests();
...
```js
import { createOrderRequest, updateProjectStatus, listMyOrderRequests, deleteProject } from '@dataconnect/generated';


// Operation CreateOrderRequest:  For variables, look at type CreateOrderRequestVars in ../index.d.ts
