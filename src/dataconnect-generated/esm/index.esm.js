...
export const createOrderRequestRef = (dcOrVars, vars) => {
...
export function createOrderRequest(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
export const listMyOrderRequestsRef = (dc) => {
...
export function listMyOrderRequests(dcOrOptions, options) {
